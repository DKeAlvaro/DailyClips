...
def download_random_video():
    ...
    try:
        ...
        local_video_dir = Path('static/videos')
        local_subtitle_dir = Path('static/subtitles')
...
def download_videos(n=3):
    """Download n videos and their subtitles from Dropbox, then move them to 'Seen' folder."""
    for _ in range(n):
